function out_seq = channelCoding_interleaving (in_seq)
    %channelCoding_interleaving process of interleaving 
    % after polar coding [7.1.4, TS 38.212] -> [5.3.1.1, TS 38.212]
